...
FetchMeetingDetailsModel fetchMeetingDetailsModelFromJson(String str) => FetchMeetingDetailsModel.fromJson(json.decode(str));

String fetchMeetingDetailsModelToJson(FetchMeetingDetailsModel data) => json.encode(data.toJson());
...
class FetchMeetingDetailsModel {
  ...
  factory FetchMeetingDetailsModel.fromJson(Map<String, dynamic> json) => FetchMeetingDetailsModel(
    status: json["Status"],
