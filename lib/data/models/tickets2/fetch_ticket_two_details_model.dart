class FetchTicketTwoDetailsModel {
  final int status;
  final String message;
  final TicketTwoData data;
  ...
  factory FetchTicketTwoDetailsModel.fromJson(Map<String, dynamic> json) =>
      FetchTicketTwoDetailsModel(
        status: json["Status"],
        message: json["Message"],
        data: TicketTwoData.fromJson(json["Data"]),
      );
...
class TicketTwoData {
  ...
  final String affectedEquipment;
  final String distlist;
  ...
  factory TicketTwoData.fromJson(Map<String, dynamic> json) => TicketTwoData(
      ...
      affectedEquipment: json['affectedequipment'] ?? '',
