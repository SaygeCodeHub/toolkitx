...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        sourcetankreading: List<Tankreading>.from(
            json["sourcetankreading"].map((x) => Tankreading.fromJson(x))),
        destinationtankreading: List<Tankreading>.from(
            json["destinationtankreading"].map((x) => Tankreading.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "quantity": quantity,
        "sourcetankreading":
            List<dynamic>.from(sourcetankreading.map((x) => x.toJson())),
        "destinationtankreading":
            List<dynamic>.from(destinationtankreading.map((x) => x.toJson())),
      };
}
