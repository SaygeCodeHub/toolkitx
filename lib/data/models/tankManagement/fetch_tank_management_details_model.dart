...
FetchTankManagementDetailsModel fetchTankManagementDetailsModelFromJson(String str) => FetchTankManagementDetailsModel.fromJson(json.decode(str));

String fetchTankManagementDetailsModelToJson(FetchTankManagementDetailsModel data) => json.encode(data.toJson());
...
class FetchTankManagementDetailsModel {
  ...
  factory FetchTankManagementDetailsModel.fromJson(Map<String, dynamic> json) => FetchTankManagementDetailsModel(
    status: json["Status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    approvelist: List<Approvelist>.from(json["approvelist"].map((x) => Approvelist.fromJson(x))),
  );
