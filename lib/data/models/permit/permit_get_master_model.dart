...
PermitGetMasterModel permitGetMasterModelFromJson(String str) => PermitGetMasterModel.fromJson(json.decode(str));

String permitGetMasterModelToJson(PermitGetMasterModel data) => json.encode(data.toJson());
...
class PermitGetMasterModel {
  ...
  factory PermitGetMasterModel.fromJson(Map<String, dynamic> json) => PermitGetMasterModel(
    status: json["Status"],
    message: json["Message"],
    data: List<List<PermitMasterDatum>>.from(json["Data"].map((x) => List<PermitMasterDatum>.from(x.map((x) => PermitMasterDatum.fromJson(x))))),
  );
...
class PermitMasterDatum {
  ...
  factory PermitMasterDatum.fromJson(Map<String, dynamic> json) => PermitMasterDatum(
