...
class TankChecklistQuestionUtil {
  Map value = {};
  var valueOfA = 0.0;
      ...
      case 5:
        return BlocBuilder<TankManagementBloc, TankManagementState>(
            buildWhen: (previousState, currentState) =>
                currentState is TankCheckListAnswersSelected,
            builder: (context, state) {
              if (state is TankCheckListAnswersSelected) {
                answerList[index]["answer"] = state.multiSelectId.join(',');
                return TankMultiSelectExpansionTile(
                    answerModelList: answerModelList,
                    index: index,
