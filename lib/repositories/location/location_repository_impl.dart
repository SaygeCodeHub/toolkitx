...
class LocationRepositoryImpl extends LocationRepository {
  ...
  @override
  Future<FetchLocationWorkOrdersModel> fetchLocationWorkOrders(int pageNo, String hashCode, String filter, String locationId) async {
    final response = await DioClient().get(
  ...
  @override
  Future<FetchLocationCheckListsModel> fetchLocationCheckLists(String hashCode, String filter, String locationId) async {
    final response = await DioClient().get(
  ...
  @override
  Future<FetchLocationAssetsModel> fetchLocationAssets(int pageNo, String hashCode, String filter) async {
    final response = await DioClient().get(
  ...
  Future<FetchLocationLogBookModel> fetchLocationLogBooks(int pageNo,
    ...
    log('repo--------->"${ApiConstants.baseUrl}common/getlocationlogbooks?pageno=$pageNo&hashcode=$hashCode&filter=$filter&locationid=$locationId&userid=$userId")');
    final response = await DioClient().get(
