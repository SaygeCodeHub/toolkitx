...
class DocumentCustomTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        ...
        child: ListView.builder(
            ...
            itemCount: documentDetailsModel.data.logs.length,
  ...
  Widget _buildVerticalTimelinePath(int index, context) {
    return Column(children: [
      ...
      Visibility(
          visible: index != documentDetailsModel.data.logs.length - 1,
          child: Container(
              width: 1,
  ...
  Widget _buildDateAndTime(int index) {
    List<String> dateTime =
        documentDetailsModel.data.logs[index].createdAt.split(' ');
    return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
