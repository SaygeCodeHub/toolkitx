...
class CertificateQuizReportWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<StartCourseCertificateBloc,
        StartCourseCertificateState>(listener: (context, state) {
      if (state is CertificateQuizReattempting) {
        ProgressBar.show(context);
      } else if (state is CertificateQuizReattempted) {
      ...
      } else if (state is CertificateQuizNotReattempted) {
        ProgressBar.dismiss(context);
          ...
          Visibility(
              ...
              child: PrimaryButton(
                  onPressed: () {
                    context
                        .read<StartCourseCertificateBloc>()
                        .add(ReattemptCertificateQuiz(workforceQuizId: quizId));
                  },
                    ...
                    child: Padding(
                        ...
                        child: ListTile(
                            title: data[index].answerstatus == '1'
                                ...
                                : Text(DatabaseUtil.getText('Incorrect'),
                                    style: Theme.of(context)
                                        .textTheme
                                        .xSmall
                                        .copyWith(
                            ...
                            subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text('Q${index + 1}: ${data[index].title}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .xSmall
                                          .copyWith(
