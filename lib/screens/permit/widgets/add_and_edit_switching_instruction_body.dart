    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      InstructionReceivedExpansionTile(
        ...
        editName: isFromEdit == true
            ? permitSwithcingScheduleInstructionDatum.instructionreceivedbyname
            : '',
      ),
      const SizedBox(height: xxxSmallestSpacing),
      ...
      ControlEngineerExpansionTile(
        ...
        editValue: isFromEdit == true
            ? permitSwithcingScheduleInstructionDatum.controlengineername
            : '',
      ),
      const SizedBox(height: xxxSmallestSpacing),
      ...
      TextFieldWidget(
        value: isFromEdit == true
            ? permitSwithcingScheduleInstructionDatum.safetykeynumber
            : '',
        onTextFieldChanged: (textField) {
