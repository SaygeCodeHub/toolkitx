...
class SafetyNoticeDetailsTabTwo extends StatelessWidget {
  final int tabIndex;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Visibility(
        visible: safetyNoticeData.logs.isNotEmpty,
        replacement: Center(
          child: Text(StringConstants.kNoLogs,
              style: Theme.of(context).textTheme.medium),
        ),
        child: ListView.builder(
          physics: const BouncingScrollPhysics(),
          itemCount: safetyNoticeData.logs.length,
  ...
  Widget _buildVerticalTimelinePath(int index, context) {
    return Column(
      children: [
        ...
        Visibility(
          visible: index != safetyNoticeData.logs.length - 1,
          child: Container(
            width: 1,
  ...
  Widget _buildDateAndTime(int index) {
    List<String> dateTime = safetyNoticeData.logs[index].createdAt.split(' ');
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
  ...
  Widget _buildContent(int index, context) {
    return Column(
      ...
      children: [
        Text(
          safetyNoticeData.logs[index].createdBy,
        ...
        SizedBox(
            ...
            child: Text(
              safetyNoticeData.logs[index].createdAt,
