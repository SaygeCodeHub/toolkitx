  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SignInLocationDetailsBloc, SignInLocationDetailsStates>(
        buildWhen: (previousState, currentState) =>
            currentState is SignInLocationDetailsFetched,
          ...
          if (state is SignInLocationDetailsFetched) {
            if (state.fetchLocationDetailsSignInModel.data.permit!.isNotEmpty ||
                ...
                state.fetchLocationDetailsSignInModel.data.checklist!
                    .isNotEmpty) {
              if (context.read<SignInLocationDetailsBloc>().indexSelected ==
                  0) {
                return (state
                        .fetchLocationDetailsSignInModel.data.permit!.isEmpty)
                    ? Padding(
                    ...
                    : SignInPermitLocationDetailsCard(
                        permit:
                            state.fetchLocationDetailsSignInModel.data.permit!,
                      ...
                      .indexSelected ==
                  1) {
                return (state.fetchLocationDetailsSignInModel.data.workorder!
                        .isEmpty)
                    ? Padding(
                        padding: EdgeInsets.only(
                            top: MediaQuery.of(context).size.height / 3.5),
                    ...
                    : SignInWorkOrderLocationDetailsCard(
                        workOrder: state
                            .fetchLocationDetailsSignInModel.data.workorder!,
                        locationId: locationId,
                      );
              } else if (context
                      .read<SignInLocationDetailsBloc>()
                  ...
                  2) {
                return (state
                        .fetchLocationDetailsSignInModel.data.loto!.isEmpty)
                    ? Padding(
                        padding: EdgeInsets.only(
                            top: MediaQuery.of(context).size.height / 3.5),
                        child: Center(
                ...
                return (state.fetchLocationDetailsSignInModel.data.checklist!
                        .isEmpty)
                    ? Padding(
                        padding: EdgeInsets.only(
                            top: MediaQuery.of(context).size.height / 3.5),
                    ...
                    : SignInCheckListLocationDetailsCard(
                        checkList: state
                            .fetchLocationDetailsSignInModel.data.checklist!,
                        locationId: locationId,
                      );
              }
            } else {
