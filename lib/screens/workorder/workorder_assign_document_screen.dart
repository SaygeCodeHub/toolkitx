...
class WorkOrderAddDocumentScreen extends StatelessWidget {
  ...
  const WorkOrderAddDocumentScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          child: PrimaryButton(
              onPressed: () {}, textValue: DatabaseUtil.getText('buttonDone')),
        ),
        body: Padding(
                    ...
                    builder: (context, state) {
                      if (state is WorkOrderDocumentsFetched) {
                        return CustomIconButtonRow(
                            ...
                            clearVisible: WorkOrderAddDocumentScreen
                                .documentFilterMap.isNotEmpty,
                            primaryOnPress: () {
                              Navigator.pushNamed(context,
                                  WorkOrderDocumentFilterScreen.routeName);
                            },
                            secondaryOnPress: () {},
                            clearOnPress: () {
                              context
                ...
                BlocBuilder<WorkOrderTabDetailsBloc, WorkOrderTabDetailsStates>(
                    ...
                    builder: (context, state) {
                      if (state is FetchingWorkOrderDocuments) {
                        ...
                        if (state
                            .fetchWorkOrderDocumentsModel.data.isNotEmpty) {
                          documentDataList
                          ...
                          if (state.fetchWorkOrderDocumentsModel.status ==
                              204) {
                            if (state.filterMap.isEmpty) {
                              ...
                              return NoRecordsText(
                                  text:
                                      DatabaseUtil.getText('no_records_found'));
                            }
                          } else {
