...
class ExpenseDetailsTabTwo extends StatelessWidget {
  final int tabIndex;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemCount: expenseDetailsData.logs.length,
  ...
  Widget _buildVerticalTimelinePath(int index, context) {
    return Column(
      children: [
        ...
        Visibility(
          visible: index != expenseDetailsData.logs.length - 1,
          child: Container(
            width: 1,
  ...
  Widget _buildDateAndTime(int index) {
    List<String> dateTime = expenseDetailsData.logs[index].createdAt.split(' ');
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
  ...
  Widget _buildContent(int index, context) {
    return Column(
      ...
      children: [
        Text(
          expenseDetailsData.logs[index].createdBy,
        ...
        SizedBox(
          ...
          child: Text(
            expenseDetailsData.logs[index].action,
