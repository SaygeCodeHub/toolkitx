...
class TicketTwoLogTab extends StatelessWidget {
  const TicketTwoLogTab({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemCount: ticketTwoData.logs.length,
        itemBuilder: (context, index) {
          if (ticketTwoData.logs.isNotEmpty) {
            return Row(
  ...
  Widget _buildVerticalTimelinePath(int index, context) {
    return Column(
      children: [
        ...
        Visibility(
          visible: index != ticketTwoData.logs.length - 1,
          child: Container(
            width: 1,
  ...
  Widget _buildDateAndTime(int index) {
    List<String> dateTime = ticketTwoData.logs[index].createdAt.split(' ');
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
  ...
  Widget _buildContent(int index, context) {
    return Column(
      ...
      children: [
        Text(
          ticketTwoData.logs[index].createdBy,
        ...
        SizedBox(
            ...
            child: Text(
              ticketTwoData.logs[index].action,
