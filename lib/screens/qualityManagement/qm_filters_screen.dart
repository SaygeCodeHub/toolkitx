...
import 'package:toolkit/screens/qualityManagement/widgets/qm_category_filter.dart';
...
class QualityManagementFilterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    context
        ...
        .add(FetchQualityManagementList(isFromHome: false, pageNo: 1));
    return Scaffold(
                      ...
                      children: [
                        ...
                        Text(DatabaseUtil.getText('Category'),
                            style: Theme.of(context)
                                ...
                                .copyWith(fontWeight: FontWeight.w600)),
                        const SizedBox(height: xxxSmallerSpacing),
                        QMCategoryFilter(qmFilterMap: qmFilterMap)
                      ]));
            } else {
      ...
      bottomNavigationBar: Padding(
        ...
        child: PrimaryButton(
            onPressed: () {
              if (qmFilterMap['st'] != null && qmFilterMap['et'] == null ||
                  qmFilterMap['st'] == null && qmFilterMap['et'] != null) {
                showCustomSnackBar(
                    context, DatabaseUtil.getText('TimeDateValidate'), '');
              } else {
                context
                    .read<QualityManagementBloc>()
                    .add(QualityManagementApplyFilter(filtersMap: qmFilterMap));
